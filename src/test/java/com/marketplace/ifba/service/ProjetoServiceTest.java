...
class ProjetoServiceTest {
    ...
    void setUp() {
        ...
        // 🔹 já inicializa a lista de usuários para evitar NPE em registrarProjeto
    ...
    void deveLancarExcecaoAoBuscarProjetoPorNomeNaoExistente() {
        ...
        assertThrows(ProjetoInvalidoException.class,
                () -> projetoService.buscarProjetoPorNome("Inexistente"));
    }
    ...
    void deveAdicionarEntregaComSucesso() {
        ...
        when(projetoRepository.findById(projetoId)).thenReturn(Optional.of(projeto));
        when(organizacaoRepository.findById(idOrgSolicitante)).thenReturn(Optional.of(projeto.getOrganizacao()));
    ...
    void deveBuscarProjetosPorInstituicao() {
        ...
        List<Projeto> result = projetoService.buscarProjetosPorInstituicao(projeto.getInstituicao().getIdInstituicao());
    ...
    void deveBuscarProjetosPorOrganizacao() {
        ...
        List<Projeto> result = projetoService.buscarProjetosPorOrganizacao(projeto.getOrganizacao().getIdOrganizacao());
    ...
    void deveLancarExcecaoQuandoOrganizacaoSolicitanteNaoEncontrada() {
        ...
        assertThrows(OrganizacaoInvalidaException.class,
                () -> projetoService.adicionarEntrega(projetoId, entrega,
                        idOrgSolic, null, null, projeto.getGrupoPesquisa().getIdGrupoPesquisa()));
    }
    ...
    // Ainda falta testar registrar projetos

    // Falta testar a entrega dos projetos

    // Falta testar atualização dos status dos projetos

    // Falta testar a finalização dos projetos
